...
Place this file in backend/app/models.py
"""
...
class BillingPlan(db.Model):
    ...
    # Pricing
    price_monthly = db.Column(db.Decimal(10, 2))
    price_yearly = db.Column(db.Decimal(10, 2))
...
class TokenUsageLog(db.Model):
    ...
    # Operation details
    operation_type = db.Column(db.String(100), nullable=False)  # analyze_idea, generate_scene, etc.
